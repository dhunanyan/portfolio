...
export const Header = () => {
  ...
  const offset = React.useMemo(() => getHeaderOffset(), []);
      ...
      <div className="header__container">
        ...
        >
          <span className="header__logo-mark">
            <Image
              src={Icons['logo-fill']}
              alt="Davit Hunanyan logo"
              fill
              sizes="50px"
              className="header__logo-image header__logo-image--fill"
              priority
            />
            <Image
              src={Icons['logo-bold']}
              ...
              fill
              sizes="50px"
              className="header__logo-image header__logo-image--bold"
              aria-hidden
            />
          </span>
        </Link>
